...
void HorrorLevel::LoadScene()
{
    ...
    pointLight1.diffuse = glm::vec3(1.0f, 0.2f, 0.1f);
    ...
    pointLight2.diffuse = glm::vec3(1.0f, 0.2f, 0.0f);
    ...
    pointLight3.diffuse = glm::vec3(1.0f, 0.0f, 0.0f);
...
void HorrorLevel::Update(float deltaTime)
{
