...
#pragma region LightInstancesCreation
    ...
    pointLight1.diffuse = glm::vec3(0.8f, 0.2f, 0.1f);
    ...
    pointLight2.diffuse = glm::vec3(0.8f, 0.7f, 0.1f);
    ...
    pointLight3.diffuse = glm::vec3(0.2f, 0.7f, 0.8f);
    ...
    pointLight4.diffuse = glm::vec3(0.5f, 0.8f, 0.3f);
