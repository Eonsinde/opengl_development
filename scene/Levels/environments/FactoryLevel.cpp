...
void FactoryLevel::LoadScene()
{
    ...
    pointLight1.diffuse = glm::vec3(0.3f, 0.2f, 1.0f);
    ...
    pointLight4.diffuse = glm::vec3(0.3f, 0.2f, 1.0f);
    pointLight4.specular = glm::vec3(0.5f);
    pointLight4.constant = 1.0f;
    pointLight4.linear = 0.22f;
    pointLight4.quadratic = 0.20f;
...
void FactoryLevel::Update(float deltaTime)
{
