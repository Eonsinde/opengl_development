...
void SoftSpotLightLevel::Init()
{
    ...
    lightShader = new Shader("./shaders/codes/ADS.vert", "./shaders/codes/spotlight_soft_ADS.frag");
...
void SoftSpotLightLevel::UnloadScene()
{
    if (lightShader)
        delete lightShader;
    if (cubeShader)
...
void SoftSpotLightLevel::Update(float deltaTime)
{
