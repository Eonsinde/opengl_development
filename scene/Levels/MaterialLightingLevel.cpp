#include "MaterialLightingLevel.h"

#include "../../shaders/Shader.h"
#include "../../core/Input.h"


void MaterialLightingLevel::Init()
{
    float vertices[] = {
...
void MaterialLightingLevel::UnloadScene()
{
    if (lightShader)
        delete lightShader;
    if (cubeShader)
...
void MaterialLightingLevel::Update(float deltaTime)
{
...
void MaterialLightingLevel::Draw()
{
