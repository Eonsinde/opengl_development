...
class DirectionalLightApp : public Hound::Application
{
...
class DirectionalLightLevel : public Hound::Scene
{
public:
	DirectionalLightLevel()
		: cubeVAO{}, lightVAO{}, VBO{}, lightShader{ nullptr }, cubeShader{ nullptr }, mCubeTexture{ nullptr } {
		char title[]{ "Directional Lighting Level" };
		strcpy_s(mSceneInfo.title, sizeof(title), "Directional Lighting Level");
		mSceneInfo.width = 800;
		mSceneInfo.height = 600;
	}

	virtual ~DirectionalLightLevel() {
