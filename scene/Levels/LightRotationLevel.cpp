#include "LightRotationLevel.h"

#include "../../shaders/Shader.h"
#include "../../core/Input.h"


void LightRotationLevel::Init()
{
    float vertices[] = {
...
void LightRotationLevel::LoadScene()
{

}

void LightRotationLevel::UnloadScene()
{
    if (lightShader)
        delete lightShader;
    if (cubeShader)
...
void LightRotationLevel::Update(float deltaTime)
{
