...
class MaterialLightingApp : public Hound::Application
{
...
class MaterialLightingLevel : public Hound::Scene
{
public:
	MaterialLightingLevel()
		: cubeVAO{}, lightVAO{}, VBO{}, lightShader{ nullptr }, cubeShader{ nullptr }, mCubeTexture{ nullptr } {
		char title[]{ "Materialized Cubes Rendering" };
		strcpy_s(mSceneInfo.title, sizeof(title), "Materialized Cubes Rendering");
		mSceneInfo.width = 800;
		mSceneInfo.height = 600;
	}

	virtual ~MaterialLightingLevel() {
