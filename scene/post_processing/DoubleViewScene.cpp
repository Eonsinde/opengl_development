...
void DoubleViewScene::Init()
{
    ...
    // this shader is used to render the second view
...
void DoubleViewScene::LoadScene()
{

}

void DoubleViewScene::UnloadScene()
{
    if (mainShader)
        delete mainShader;
...
void DoubleViewScene::Update(float deltaTime)
{
