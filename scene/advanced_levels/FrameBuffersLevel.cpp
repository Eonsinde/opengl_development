...
void FrameBuffersLevel::LoadScene()
{

}

void FrameBuffersLevel::UnloadScene()
{
    if (mainShader)
        delete mainShader;
...
void FrameBuffersLevel::Update(float deltaTime)
{
