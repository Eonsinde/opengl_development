...
void ZFightingLevel::LoadScene()
{

}

void ZFightingLevel::UnloadScene()
{
    if (mainShader)
        delete mainShader;
...
void ZFightingLevel::Update(float deltaTime)
{
