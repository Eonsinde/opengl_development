...
class TransparencyApp : public Hound::Application
{
public:
	TransparencyApp() {
...
class TransparencyLevel : public Hound::Scene
{
public:
	TransparencyLevel()
		: cubeVAO{}, planeVAO{}, cubeVBO{}, planeVBO{}, mainShader{ nullptr }, glassShader{ nullptr }, mCubeTexture{ nullptr }, mPlaneTexture{ nullptr }, mGlassTexture{ nullptr } {
		char title[]{ "Windows With Transparency Scene" };
		strcpy_s(mSceneInfo.title, sizeof(title), title);
		mSceneInfo.width = 800;
		mSceneInfo.height = 600;
	}

	virtual ~TransparencyLevel() {
...
//DECLARE_MAIN(TransparencyApp, TransparencyLevel)
