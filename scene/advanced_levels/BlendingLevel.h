...
class BlendingApp : public Hound::Application
{
public:
	BlendingApp() {
...
class BlendingLevel : public Hound::Scene
{
public:
	BlendingLevel()
		: cubeVAO{}, planeVAO{}, cubeVBO{}, planeVBO{}, mainShader{ nullptr }, vegShader{ nullptr }, mCubeTexture{ nullptr }, mPlaneTexture{ nullptr }, mVegTexture{ nullptr } {
...
protected:
	unsigned int cubeVAO, cubeVBO, planeVAO, planeVBO, vegetationVAO, vegetationVBO;
	/*VertexArray cubeVAO, planeVAO;
	VertexBuffer cubeVBO, planeVBO;*/
	...
	std::vector<glm::vec3> vegPositions;
};


//DECLARE_MAIN(BlendingApp, BlendingLevel)
