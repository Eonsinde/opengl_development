...
void DepthTestingLevel::LoadScene()
{

}

void DepthTestingLevel::UnloadScene()
{
    if (mainShader)
        delete mainShader;
...
void DepthTestingLevel::Update(float deltaTime)
{
